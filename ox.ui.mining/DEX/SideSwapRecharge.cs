...
namespace OX.UI.Swap
{
    public partial class SideSwapRecharge : DarkDialog
    {
        ...
        private void btnYes_Click(object sender, EventArgs e)
        {
            ...
            var assetId = this.rbPriceAsset.Checked ? Blockchain.OXC : this.AssetId;
            SingleTransactionWrapper<ContractTransaction> stw = new SingleTransactionWrapper<ContractTransaction>(fromAddress, new TransactionOutput { AssetId = assetId, ScriptHash = this.PoolAddress, Value = amount });
