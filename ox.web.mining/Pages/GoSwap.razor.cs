...
namespace OX.Web.Pages
{
    ...
    public partial class GoSwap
    {
        public override string PageTitle => UIHelper.LocalString("主池交易", "Main Pool Exchange");
        [Parameter]
        ...
        async void reloadChart()
        {
            try
            {
                ...
                var data = pv.GetAll<SwapPairExchangeKey, SwapVolumeMerge>(InvestBizPersistencePrefixes.SwapPairExchange, pool);
        ...
        protected override async void OnMiningInit()
        {
            ...
            {
                AssetId = SwapPairMerge.TargetAssetState.AssetId;
                AssetName = SwapPairMerge.TargetAssetState.GetName();
            }
